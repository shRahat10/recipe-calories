const Header = () => {
    return (
        <div>
            ...
            <section>
                <div className="space-y-10 w-full h-fit xl:h-[700px] py-14 px-2 lg:px-44 rounded-3xl text-center flex flex-col justify-center items-center bg-cover bg-center bg-no-repeat text-white relative" style={{ backgroundImage: "url('./images/banner.jpg')" }}>
